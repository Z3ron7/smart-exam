...
const Dashboard = () => {
    ...
    return (
        <div className='dash dark:bg-darkBlue-800'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4'>
                ...
                <div className=' dark:bg-darkBlue-800 border-2 h-[100px] rounded-[8px] bg-white border-l-[6px] border-[#4E73DF] flex items-center px-[30px] cursor-pointer hover:shadow-lg transform hover:scale-[103%] transition duration-300 ease-out'>
                ...
                <div className='dark:bg-darkBlue-800 border-2 h-[100px] rounded-[8px] bg-white border-l-[6px] border-[#1CC88A] flex items-center px-[30px] cursor-pointer hover:shadow-lg transform hover:scale-[103%] transition duration-300 ease-out'>
                <div className="rounded-full h-12 w-12 flex items-center justify-center bg-orange-600">
                    <FaRegCalendarMinus fontSize={28} color="" />
				</div>
                    <div>
                ...
                <div className='dark:bg-darkBlue-800 border-2 h-[100px] rounded-[8px] bg-white border-l-[6px] border-[#36B9CC] flex items-center px-[30px] cursor-pointer hover:shadow-lg transform hover:scale-[103%] transition duration-300 ease-out'>
                <div className="rounded-full h-12 w-12 flex items-center justify-center bg-orange-600">
                    <FaRegCalendarMinus fontSize={28} color="" />
				</div>
                    <div>
                ...
                <div className='dark:bg-darkBlue-800 border-2 h-[100px] rounded-[8px] bg-white border-l-[6px] border-[#F6C23E] flex items-center px-[30px] cursor-pointer hover:shadow-lg transform hover:scale-[103%] transition duration-300 ease-out'>
                <div className="rounded-full h-12 w-12 flex items-center justify-center bg-orange-600">
                    <FaRegCalendarMinus fontSize={28} color="" />
				</div>
                    <div>
            ...
            <div className='basis-[53%] border bg-white shadow-md cursor-pointer rounded-[4px] dark:bg-darkBlue-800 mb-4 md:mb-0 lg:mb-0 lg:mr-4'>
                ...
                <div className='basis-[30%] border bg-white shadow-md cursor-pointer rounded-[4px] dark:bg-darkBlue-800'>
            ...
            <div className='basis-[55%] border bg-white shadow-md cursor-pointer rounded-[4px] dark:bg-darkBlue-800 mb-4 md:mb-0 lg:mb-0 lg:mr-4'>
                    <div className='bg-[#F8F9FC] flex items-center justify-between py-[15px] px-[20px] border-b-[1px] dark:bg-darkBlue-900 border-[#EDEDED]'>
                ...
                <div className='basis-[45%] border bg-white shadow-md cursor-pointer rounded-[4px] dark:bg-darkBlue-800'>
                    <div className='bg-[#F8F9FC] flex items-center justify-between py-[15px] px-[20px] border-b-[1px] dark:bg-darkBlue-900 border-[#EDEDED]'>
